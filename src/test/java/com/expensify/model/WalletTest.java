...
public class WalletTest {
    @Test
    public void getAllWalletDetailsServiceSuccessTest() throws SQLException {
    ...
    @Test
    public void getAllWalletDetailsServiceFailureTest() throws SQLException {
        WalletDAOServiceMock walletDAOServiceMock = new WalletDAOServiceMock();
        List<IWallet> allWalletDetails = walletDAOServiceMock.getAllWalletDetails(1);
        Assertions.assertEquals(0, allWalletDetails.size());
    }
